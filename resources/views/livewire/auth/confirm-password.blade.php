    ...
    <section class="card w-md bg-base-200 shadow-sm">
        <div class="card-body">
            <x-form wire:submit="confirmPassword">
                ...
                <x-input label="{{ __('Password') }}" wire:model="password" placeholder="********" right
                    autofocus autocomplete="new-password" />


                <div class="mt-6 grid gap-2">
                    <x-button type="submit" class="btn btn-primary btn-block" spinner="confirmPassword">{{ 'Confirm' }}</x-button>
                </div>
            </x-form>
    </section>
</div>
